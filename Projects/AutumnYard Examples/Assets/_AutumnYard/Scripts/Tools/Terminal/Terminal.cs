...
namespace AutumnYard.Tools.Terminal
{
    ...
    public class Terminal : MonoBehaviour
    {
        ...
        [SerializeField] private bool ShowGUIButtons = false;
        [SerializeField] private bool RightAlignButtons = false;

        [Header("Theme")]
        [Range(0, 1)]
        [SerializeField] private float InputContrast = 0.0f;
        [Range(0, 1)]
        ...
        public void SetState(TerminalState new_state)
        {
            ...
            switch (new_state)
            {
                case TerminalState.Close:
                    {
                        open_target = 0;
                        //AutumnYard.Input.InputHandler.Instance.EnterContext(AutumnYard.Context.Game);
                        //AutumnYard.DirectorGame.Instance.ChangeControlMode(AutumnYard.ControlMode.Gameplay);
                        break;
                    }
                case TerminalState.OpenSmall:
                    {
                        //AutumnYard.Input.InputHandler.Instance.EnterContext(AutumnYard.Context.None);
