...
{
    public sealed class Example2Director : MonoBehaviour
    {
        ...
        [SerializeField] private UI.Example2UIManager _ui;

        private void Awake()
        {
            if (_ui == null) _ui = FindObjectOfType<UI.Example2UIManager>();

            SceneHandler.Instance.ForceSetCurrentContext(SceneHandler.Context.Example2);
        ...
        private void ChangeMode_ToUI(UI.Example2UIManager.Menu menuToOpen)
        {
            ...
            switch (menuToOpen)
            {
                case UI.Example2UIManager.Menu.Pause:
                    _ui.OpenPause();
                    break;
            }
        ...
        public void Button_OpenPause() => ChangeMode_ToUI(UI.Example2UIManager.Menu.Pause);
