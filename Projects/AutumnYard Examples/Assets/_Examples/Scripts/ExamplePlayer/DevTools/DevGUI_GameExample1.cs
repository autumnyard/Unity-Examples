...
namespace AutumnYard.ExamplePlayer.DevTools
{
    public sealed class DevGUI_GameExample1 : MonoBehaviour
    {
        ...
        private ExamplePlayerDirector _game;
        private UI.ExamplePlayerUI _ui;
        ...
        private void Start()
        {
            _game = FindObjectOfType<ExamplePlayerDirector>();
            _ui = FindObjectOfType<UI.ExamplePlayerUI>();
