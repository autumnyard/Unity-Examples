...
namespace AutumnYard.ExamplePlayer.UI
{
    public sealed partial class HUDManager : SingleInstance<HUDManager>
    {
        ...
        private ExamplePlayerDirector _director;
        ...
        private void SetDependencies()
        {
            ...
            if (_director == null) _director = FindObjectOfType<ExamplePlayerDirector>();
        }
        ...
        private void HandleChangeGameState(ExamplePlayerDirector.State newGameState)
        {
            switch (newGameState)
            {
                case ExamplePlayerDirector.State.Play:
                    SetState(State.Game);
                    break;

                case ExamplePlayerDirector.State.UI:
